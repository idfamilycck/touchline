  ...
  return (
    <div className="panel flex w-full flex-col rounded-panel lg:h-full lg:min-h-0">
      ...
      <ul
        ...
        className="flex flex-col px-1.5 py-1 max-h-[clamp(240px,42vh,460px)] overflow-y-auto lg:max-h-none lg:min-h-0 lg:flex-1 lg:overflow-y-auto"
      >
        {rows.map((e, i) => {
          ...
          return (
            <li
              ...
              className={`data-row flex items-start gap-1.5 px-1 py-2 ${
                isGoal
            ...
            >
              <span
                className="stat-num mt-0.5 shrink-0 text-left text-[13px] tabular-nums text-dim"
                aria-hidden
              >
